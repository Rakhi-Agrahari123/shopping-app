...
function EmailSubscribtion() {
  return (
    <div className=' container mx-auto bg-black text-center  w-full h-full text-justify-center m-0 rounded-md' m-0>
    ...
    <button className='bg-red-600 text-white ml-3 text-sl rounded-md hover:text-black border-white border-e-4 h-10'>Subscription</button>
    </h2>
</div>
  )
}
